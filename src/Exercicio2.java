public class Exercicio2 {
    public static void main(String[] args){
        ...
        System.out.println("b1 ^ b3 " + (b1 ^ b2));//-> ^ disjunção exclusiva
        System.out.println("b4 ^ b1 " + (b1 ^ b2));//-> ^ disjunção exclusiva
        ...
        boolean recebeAuxilio = (salarioBaixo) && (muitoaDependentes);
